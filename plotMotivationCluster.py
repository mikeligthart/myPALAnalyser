...
area=np.ones(14)*150
area[6]=5
max_motivation = np.trapz(np.array([7,7,7]))
min_motivation = np.trapz(np.array([1,1,1]))
total_motivation = (total_motivation - min_motivation) / (max_motivation - min_motivation)
...
x_label = plt.xlabel('Total Motivation')
y_label = plt.ylabel('#Added Content')

plt.grid()
plt.savefig('data/cleaned/summary_plots/motivation_vs_added_content.png', dpi=300, bbox_extra_artists=(title, x_label, y_label, ), bbox_inches='tight')
#plt.savefig('data/cleaned/summary_plots/motivation_vs_added_content.svg', dpi=300, bbox_extra_artists=(title, x_label, y_label, ), bbox_inches='tight', format='svg')
plt.close()
...
#plt.savefig('data/cleaned/summary_plots/motivation_vs_consistency.svg', bbox_extra_artists=(lgd, title, x_label, y_label, ), bbox_inches='tight', format='svg')
plt.close()